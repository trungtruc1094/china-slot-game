(function (globalScope) {
    ...
    globalScope.CHINA_SLOT_TEVI_CONFIG = {
        ...
        appId: teviConfig.appId || globalScope.TEVI_APP_ID || "",
        channelId: teviConfig.channelId || globalScope.TEVI_CHANNEL_ID || "",
        appUrl: teviConfig.appUrl || globalScope.TEVI_APP_URL || "",
        webhookUrl: teviConfig.webhookUrl || globalScope.TEVI_WEBHOOK_URL || "",
